...
function pruebas(req,res){
    res.status(200).send({message:'acci�n de pruebas'});
};
...
//funci�n buena antes de la modificacion con follows
      ...
      //funci�n modificada con los follows
      //function getUser(req, res) {
        //var userId=req.params.id;
      ...
      //funcion implementada con mostrando que usuarios me est�n siguiendo
     /* function getUser(req, res) {
        var userId = req.params.id;
    ...
    //funci�n de udemy mal implementada
    ...
    //funci�n get users actualizada con follows pero con el codigo de udemy
...
//funcion uploadImage gt
    /*  function uploadImage(req,res){
      ...
      //funcion uploadImage vr con la otra funci�n
      ...
      /*function getUserImage(req, res) {
        ...
        User.findById(userId)
          .then((user) => {
            ...
            // Si la imagen se env�a como un archivo adjunto en la petici�n, se guarda en la carpeta 'uploads' y se a�ade su ruta al objeto 'user'
            if (req.file) {
      ...
      function getUserImage(req, res) {
        ...
        User.findById(userId)
          .then((user) => {
            ...
            // Si la imagen se env�a como un archivo adjunto en la petici�n, se guarda en la carpeta 'uploads' y se actualiza la propiedad 'image' del objeto 'user'
            if (req.file) {
              const imagePath = req.file.path;
              const imageBuffer = fs.readFileSync(imagePath); // Lee el archivo como un buffer
              const imageType = req.file.mimetype.split('/')[1]; // Obtiene la extensi�n del archivo
